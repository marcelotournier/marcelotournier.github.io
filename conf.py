...
# (translatable)
CONTENT_FOOTER = '<center>Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}<br>&copy; {date}<br><a rel="me" href="https://mastodon.social/@whatsup_doc">Follow me on Mastodon</a></center>'
