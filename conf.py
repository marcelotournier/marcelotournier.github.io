...
BLOG_AUTHOR = "Marcelo Tournier"  # (translatable)
BLOG_TITLE = "Marcelo Tournier"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://marcelotournier.github.io/"
...
NAVIGATION_LINKS = {
    ...
    "pt_br": (
        ("/pt_br/categories/blog/", "Blog"),
        ("/pt_br/categories/code/", "Código"),
        ("/pages/o-autor", "Sobre"),
        ("https://www.linkedin.com/in/marcelotournier/", "LinkedIn"),
        ("https://github.com/marcelotournier", "Github"),
    ),
...
POSTS = (
    ...
    ("notebooks/*.ipynb", "code", "post.tmpl"), # new line
)
PAGES = (
    ("pages/*.rst", "", "page.tmpl"),
    ("pages/*.md", "", "page.tmpl"),
    ...
    # ("notebooks/*.ipynb", "pages", "page.tmpl"), # new line
)
...
TAG_DESCRIPTIONS = {
    DEFAULT_LANG: {
        "blog": "Welcome to my memory dump of random ideas. Not my employer opinions.",
        "code": "This is my cookbook of Notebooks and scripts. Enjoy!"
    },
}
...
#    DEFAULT_LANG: {
#        "blog": "Meta-posts about blogging",
#        "code": "Posts about code, snippets and tutorials"
#    },
#}
...
# (translatable)
CONTENT_FOOTER = '<center>Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}<br>&copy; {date}<br>Follow me on <a rel="me" href="https://mastodon.social/@whatsup_doc">Mastodon</a></center>'
...
# is in the manual.
COMMENT_SYSTEM_ID = "marcelo-tournier"
